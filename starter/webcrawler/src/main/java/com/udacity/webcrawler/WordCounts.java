...
final class WordCounts {
  ...
  private static Comparator<? super Map.Entry<String, Integer>> WordCountComparator;
  ...
  static Map<String, Integer> sort(Map<String, Integer> wordCounts, int popularWordCount) {
    ...
    int val1 = popularWordCount;
    int val2 = wordCounts.size();

    Map<String, Integer> TopPriorityCounts1 = wordCounts.entrySet()
            .stream()
            .sorted((a,b) ->
  ...
  private static final class WordCountComparator implements Comparator<Map.Entry<String, Integer>> {
    ...
    public int compare(Map.Entry<String, Integer> a, Map.Entry<String, Integer> b) {
      if (a.getValue() != (b.getValue())) {
        ...
        return (int)(b.getKey().length() - a.getKey().length());
      }else {
        return (int)(a.getKey().compareTo(b.getKey()));
      }
    }
  }
